...
/**
 @file te_tracecontroltestplugin.cpp
 @internalTechnology
*/
...
TInt CTestFileWriter::Write(const TDesC8& aText)
	{
	#if defined(__TEST_LIGHTLOGGER_ENABLED) && defined(__VERBOSE_MODE)
	__TEST_MARK_METHOD("CFileWriter::Write")
	#endif
...
const TImplementationProxy ImplementationTable[] =
    {
           // {{0x102836BF},CTestFileWriter::NewL}
           IMPLEMENTATION_PROXY_ENTRY(0x102836BF, CTestFileWriter::NewL)
    };
