...
/**
 @file Te_UloggerServerTestSuiteStepBase.h
 @internalTechnology
*/
...
* 
****************************************************************************/
class CTe_UloggerServerTestSuiteStepBase : public CTestStep
	{
public:
	virtual ~CTe_UloggerServerTestSuiteStepBase();
	CTe_UloggerServerTestSuiteStepBase();
